	...
	<body>
		...
		<div id="show-modal" class="content scaffold-show" role="main">
			...
			<ol class="property-list modal">
				...
				<g:if test="${modalInstance?.className}">
				<li class="fieldcontain">
					<span id="className-label" class="property-label"><g:message code="modal.className.label" default="Class Name" /></span>
					
						<span class="property-value" aria-labelledby="className-label"><g:fieldValue bean="${modalInstance}" field="className"/></span>
				...
				<g:if test="${modalInstance?.title}">
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="modal.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${modalInstance}" field="title"/></span>
