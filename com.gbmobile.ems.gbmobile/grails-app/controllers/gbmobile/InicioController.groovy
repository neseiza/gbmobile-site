...
class InicioController {
    ...
    def sendmail()
    {
    	def destinatario = "noe.aguilar@gbmobile.com"
		...
		"<body><h3>Informacion de contacto</h3><p>Nombre: <b>"+params.name+"</b></p><p>Empresa: <b>"+params.telefono+"</b></p><p>Email: <b>"+params.email+"</b></p></body></html>"
